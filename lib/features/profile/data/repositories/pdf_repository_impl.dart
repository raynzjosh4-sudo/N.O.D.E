...
class PdfRepositoryImpl implements PdfRepository {
  ...
  Future<Either<Failure, void>> savePdfMetadata({
    ...
    required String filePath, // local path generated by the device
    required String fileSize,
  }) async {
    try {
      final file = File(filePath);
      if (!await file.exists()) {
        return const Left(ServerFailure('PDF file not found on device for upload.'));
      }
      ...
      if (publicUrl == null) {
        return const Left(ServerFailure('Failed to upload PDF to cloud storage.'));
      }
