    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: () async {
              if (widget.doc.fileUrl.startsWith('http')) {
                await Share.share(
                  'Order Sheet: ${widget.doc.title}\n\nDownload: ${widget.doc.fileUrl}',
      ...
      body: Container(
        ...
        child: widget.doc.fileUrl.startsWith('http')
            ? PdfViewer.uri(
                Uri.parse(widget.doc.fileUrl),
